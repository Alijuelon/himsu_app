<x-app-layout>
    ...
    <div class="bg-white dark:bg-navy-700 rounded-xl shadow-sm p-6 border border-transparent dark:border-white/5 transition-colors">
        ...
        {{-- Info Read-Only --}}
        <div class="mb-6 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 rounded-xl p-4 flex items-center">
            <div class="flex-shrink-0 bg-blue-100 dark:bg-blue-500/20 text-blue-600 rounded-full w-10 h-10 flex items-center justify-center">
                <i class="fa-solid fa-eye"></i>
            </div>
            <div class="ml-4">
                <h3 class="text-sm font-bold text-blue-800 dark:text-blue-400">Mode Hanya Lihat</h3>
                <p class="text-sm text-blue-700 dark:text-blue-500 mt-0.5">Sebagai Ketua Umum, Anda hanya dapat melihat data anggota. Pengelolaan data dilakukan oleh Admin/Bendahara.</p>
            </div>
        </div>
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4" x-data="{ search: '{{ request('search') }}' }">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                <form action="{{ route('ketua.anggota.index') }}" method="GET" class="relative w-full sm:w-64">
                ...
                <tbody class="text-sm text-gray-600 dark:text-gray-300">
                    @forelse ($anggota as $item)
                        <tr class="border-b border-gray-50 dark:border-white/5 hover:bg-gray-50/50 dark:hover:bg-white/5 transition">
                            ...
                            <td class="py-4 px-4">
                                <span class="inline-flex items-center px-2.5 py-1 bg-brand/10 dark:bg-brand/20 text-brand dark:text-brandHover font-semibold rounded-lg text-xs">
