<x-app-layout>
    ...
    <div class="bg-white dark:bg-navy-700 rounded-xl shadow-sm p-6 border border-transparent dark:border-white/5 transition-colors">
        ...
        <div class="mb-6 pb-6 border-b border-gray-100 dark:border-white/10">
            ...
            <form action="{{ route('ketua.laporan.index') }}" method="GET" class="flex flex-col sm:flex-row items-end gap-4">
                ...
                <div class="w-full sm:w-auto flex space-x-2">
                    ...
                    <a href="{{ route('ketua.laporan.index') }}" class="w-full sm:w-auto bg-gray-100 dark:bg-navy-600 text-gray-600 dark:text-gray-300 text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-gray-200 dark:hover:bg-navy-500 transition shadow-sm flex items-center justify-center">
                        Reset
                    </a>
                </div>
            </form>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            ...
            <a href="{{ route('ketua.laporan.pdf', ['tgl_mulai' => request('tgl_mulai'), 'tgl_akhir' => request('tgl_akhir')]) }}" target="_blank" class="w-full sm:w-auto bg-red-500 text-white text-sm font-bold px-5 py-2.5 rounded-xl hover:bg-red-600 transition shadow-sm flex items-center justify-center">
